...
static void *I_OPL_RegisterSong(void *data, int len)
{
    ...
    // MUS files begin with "MUS"; anything which doesn't have this
    // signature is assumed to already be a MIDI file. Everything is
    // parsed directly from memory - no temporary file is needed.
