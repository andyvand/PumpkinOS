    ...
    case 2: // BOOT
      switch (function) {
        case 0x50: {
          ...
          r = bmp ? (UInt32)((uint8_t *)bmp - ram) : 0;
        ...
        case 0x180: {
          ...
          h = DmGet1Resource(r0, r1);
		  r = h ? (UInt32)((uint8_t *)h - ram) : 0;
          pumpkin_id2s(r0, st);
        ...
        case 0x1E8: {
		  ...
		  r = dbP ? (UInt32)((uint8_t *)dbP - ram) : 0;
        ...
        case 0x210: {
          ...
          r0 = h ? (uint32_t)((uint8_t *)h - ram) : 0;
          }
          break;
        case 0x220: {
          // Err DmReleaseResource(MemHandle resourceH)
          h = r0 ? (MemHandle)(ram + r0) : NULL;
        ...
        case 0xC68: {
		  ...
		  r = bmp1 ? (UInt32)((uint8_t *)bmp1 - ram) : 0;
        ...
        case 0xD0C: {
          ...
          Boolean armNative = (Boolean)(*(uint16_t *)(ram + sp + 16));
