...
static __inline double fx80_to_double(floatx80 fx)
{
	uint64 d;
	double *foo;
...
static __inline floatx80 double_to_fx80(double in)
{
	uint64 *d;
...
static __inline floatx80 load_extended_float80(m68k_state_t *m68k_state, uint32 ea)
{
	uint32 d1,d2;
	uint16 d3;
	floatx80 fp;
...
static __inline void store_extended_float80(m68k_state_t *m68k_state, uint32 ea, floatx80 fpr)
{
...
static __inline floatx80 load_pack_float80(m68k_state_t *m68k_state, uint32 ea)
{
	uint32 dw1, dw2, dw3;
	floatx80 result;
	double tmp;
...
static __inline void store_pack_float80(m68k_state_t *m68k_state, uint32 ea, int k, floatx80 fpr)
{
	uint32 dw1, dw2, dw3;
	char str[128], *ch;
	int i, j, exp;
...
static __inline void SET_CONDITION_CODES(m68k_state_t *m68k_state, floatx80 reg)
{
...
static __inline int TEST_CONDITION(m68k_state_t *m68k_state, int condition)
{
