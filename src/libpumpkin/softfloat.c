...
static __inline bits32 extractFloat32Frac( float32 a )
{
	return a & 0x007FFFFF;
...
static __inline int16 extractFloat32Exp( float32 a )
{
	return ( a>>23 ) & 0xFF;
...
static __inline flag extractFloat32Sign( float32 a )
{
	return a>>31;
...
static __inline float32 packFloat32( flag zSign, int16 zExp, bits32 zSig )
{
...
static __inline bits64 extractFloat64Frac( float64 a )
{
...
static __inline int16 extractFloat64Exp( float64 a )
{
	return ( a>>52 ) & 0x7FF;
...
static __inline flag extractFloat64Sign( float64 a )
{
	return a>>63;
...
static __inline float64 packFloat64( flag zSign, int16 zExp, bits64 zSig )
{
...
static __inline bits64 extractFloat128Frac1( float128 a )
{
	return a.low;
...
static __inline bits64 extractFloat128Frac0( float128 a )
{
...
static __inline int32 extractFloat128Exp( float128 a )
{
...
static __inline flag extractFloat128Sign( float128 a )
{
	return a.high>>63;
...
//    bSign = extractFloat32Sign( b );
	...
	if ( expDiff < 32 ) {
		...
		while ( 0 < expDiff ) {
			...
			q64 = ( 2 < q64 ) ? q64 - 2 : 0;
			aSig64 = (bits64)(-(long long)(( ( bSig * q64 )<<38 )));
			expDiff -= 62;
		}
		expDiff += 64;
		q64 = estimateDiv128To64( aSig64, 0, bSig64 );
	...
	if ( zSign ) aSig = (bits64)-((long long)aSig);
...
//    bSign = extractFloat64Sign( b );
	...
	while ( 0 < expDiff ) {
		...
		q = ( 2 < q ) ? q - 2 : 0;
		aSig = (bits64)-((long long)( ( bSig>>2 ) * q ));
		expDiff -= 62;
	}
	expDiff += 64;
	if ( 0 < expDiff ) {
