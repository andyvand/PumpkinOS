...
static uint32_t tos_gemdos_systrap(void) {
  ...
  int32_t id = 0;
  uint32_t aact = 0;
  struct g_sigaction *act = NULL;
  uint32_t aoact = 0;
  struct g_sigaction *oact = NULL;
  int16_t vec = 0;
  uint32_t auptime = 0;
  int32_t *uptime = NULL;
  int16_t request = 0;
  ...
  int32_t *interval = NULL;
  uint32_t avalue = 0;
  int32_t *valuep = NULL;
  uint32_t aointerval = 0;
  int32_t *ointerval = NULL;
  uint32_t aovalue = 0;
  int32_t *ovalue = NULL;
  uint32_t astat = 0;
  STAT *stat = NULL;
  ...
  uint32_t afds = 0;
  int16_t *fds = NULL;
  struct g_sockaddr *names = NULL;
  uint32_t aanamelen = 0;
  uint32_t *anamelen = NULL;
  int32_t backlog = 0;
  uint32_t ato = 0;
  struct g_sockaddr *to = NULL;
  uint32_t *addrlen = NULL;
  int32_t buflen = 0;
  void *valv = NULL;
  uint32_t valsize = 0;
  int32_t level = 0;
  uint32_t aval = 0;
  uint32_t *valsizep = NULL;
  uint32_t aasa = 0;
  struct g_sockaddr *asa = NULL;
  uint32_t aalen = 0;
  uint32_t *alen = NULL;
  int32_t how = 0;
  uint16_t cmd = 0;
  int32_t arg = 0;
  uint32_t aloadaverage = 0;
  int32_t *loadaverage = NULL;
  int32_t datai = 0;
  int32_t hioffset = 0;
  ...
  int32_t arg2 = 0;
  uint32_t atv = 0;
  struct g_timeval *tv = NULL;
  uint32_t atzp = 0;
  timezone *tzp = NULL;
  struct g_timeval *deltat = NULL;
  int32_t aolddelta = 0;
  struct g_timeval *olddelta = NULL;
  int16_t who = 0;
  int16_t pri = 0;
  POLLFD *fdsp = NULL;
  uint32_t nfds = 0;
  uint32_t aiov = 0;
  struct g_iovec *iov = NULL;
  int32_t niov = 0;
  int32_t number = 0;
  int32_t cmdl = 0;
  int32_t resl = 0;
    ...
    case 260: { // int32_t Fcntl(int16_t fh, int32_t arg, int16_t cmd)
        ...
        switch (cmdl) {
          case 0x5406: // TIOCGPGRP: returns via the parameter arg a pointer to the process group ID of the terminal
			write_long((uint32_t)arg, 1);
            resl = 0;
            break;
        }
        m68k_set_reg(M68K_REG_D0, resl);
		debug(DEBUG_INFO, "TOS", "GEMDOS Fcntl(%d, %d, 0x%04X): %d", fh, (uint32_t)arg, cmdl, resl);
      }
      break;
    default:
...
static uint32_t tos_xbios_systrap(void) {
  ...
  int16_t start = 0;
  int8_t *buffer = NULL;
  META_INFO_1 *bufferm = NULL;
  META_DRVINFO *bufferd = NULL;
  int16_t drive = 0;
  int32_t blockno = 0;
  int32_t magic = 0;
  int16_t flag = 0;
  uint32_t abytearray = 0;
  uint8_t *bytearray = NULL;
  int32_t starttime = 0;
  int32_t endtime = 0;
  CD_TOC_ENTRY *bufferc = NULL;
  CD_DISC_INFO *p = NULL;
  int16_t mode = 0;
  int16_t shftMode = 0;
  int16_t bankNum = 0;
  int16_t colorNum = 0;
  uint32_t apalettePtr = 0;
  int16_t *palettePtr = NULL;
  int16_t sw = 0;
  uint32_t aarray = 0;
  int32_t *array = NULL;
  int16_t index = 0;
  ...
  int8_t *data_in = NULL;
  int32_t size_in = 0;
  uint32_t adata_out = 0;
  int8_t *data_out = NULL;
  int32_t size_out = 0;
  int32_t block_insize = 0;
  int32_t block_outsize = 0;
  int32_t num_blocks = 0;
  uint32_t ablocks_done = 0;
  int32_t *blocks_done = NULL;
  uint32_t axavailable = 0;
  int32_t *xavailable = NULL;
  uint32_t ayavailable = 0;
  int32_t *yavailable = NULL;
  uint32_t ap = 0;
  int32_t *data_in32 = NULL;
  int32_t *data_out32 = NULL;
  ...
  int32_t codesize = 0;
  int16_t handle = 0;
  uint32_t areceiver = 0;
  void *receiver = NULL;
  uint32_t atransmitter = 0;
  void *transmitter = NULL;
  int32_t numsend = 0;
  int32_t numreceive = 0;
  uint32_t asendblocks = 0;
  DSPBLOCK *sendblocks = NULL;
  uint32_t areceiveblocks = 0;
  DSPBLOCK *receiveblocks = NULL;
  int16_t reg = 0;
  uint32_t abegaddr = 0;
  void *begaddr = NULL;
  uint32_t aendaddr = 0;
  void *endaddr = NULL;
  int16_t playtracks = 0;
  int16_t rectracks = 0;
  int16_t src_inter = 0;
  int16_t cause = 0;
  int16_t dspxmit = 0;
