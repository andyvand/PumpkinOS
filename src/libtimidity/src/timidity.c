...
TIMI_EXPORT int mid_init_no_config(void)
{
...
TIMI_EXPORT int mid_init(const char *config_file)
{
...
TIMI_EXPORT MidSong *mid_song_load(MidIStream *stream, MidSongOptions *options)
{
  MidSong *song;
...
TIMI_EXPORT void mid_song_free(MidSong *song)
{
  int i;
...
TIMI_EXPORT void mid_exit(void)
{
  int i, j;
...
TIMI_EXPORT long mid_get_version(void)
{
 ...
 */
TIMI_EXPORT MidDLSPatches *mid_dlspatches_load(MidIStream *stream)
{
  TIMI_UNUSED(stream);
  return NULL;
}

TIMI_EXPORT void mid_dlspatches_free(MidDLSPatches *data)
{
  TIMI_UNUSED(data);
}

TIMI_EXPORT MidSong *mid_song_load_dls(MidIStream *stream, MidDLSPatches *dlspatches, MidSongOptions *options)
{
  TIMI_UNUSED(stream);
